...
pub(crate) const PRESENTATION_OPERATION_MIGRATE: &str = "presentation.operation_migrate";
...
pub(crate) const PRESENTATION_MIGRATE_COMPLETE: &str = "presentation.migrate_complete";
pub(crate) const PRESENTATION_MIGRATE_FAILED: &str = "presentation.migrate_failed";
pub(crate) const PRESENTATION_MIGRATE_CANCELLED: &str = "presentation.migrate_cancelled";
...
pub(crate) const PRESENTATION_UNINSTALL_COMPLETE: &str = "presentation.uninstall_complete";
pub(crate) const PRESENTATION_UNINSTALL_FAILED: &str = "presentation.uninstall_failed";
pub(crate) const PRESENTATION_UNINSTALL_CANCELLED: &str = "presentation.uninstall_cancelled";
