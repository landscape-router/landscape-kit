...
pub(crate) struct ServiceMigrationScreen;

impl OperationScreen for ServiceMigrationScreen {
    fn result_key(&self, result: OperationResult) -> &'static str {
        match result {
            OperationResult::Success => crate::keys::PRESENTATION_SERVICE_MIGRATION_COMPLETE,
            OperationResult::Failed => crate::keys::PRESENTATION_SERVICE_MIGRATION_FAILED,
            OperationResult::Cancelled => crate::keys::PRESENTATION_SERVICE_MIGRATION_CANCELLED,
        }
    }
    ...
    fn render(
        ...
        let header_text = match result {
            Some(OperationResult::Success) => {
                crate::tr!(crate::keys::PRESENTATION_SERVICE_MIGRATION_COMPLETE)
            }
            Some(OperationResult::Failed) => {
                crate::tr!(crate::keys::PRESENTATION_SERVICE_MIGRATION_FAILED)
            }
            Some(OperationResult::Cancelled) => {
                crate::tr!(crate::keys::PRESENTATION_SERVICE_MIGRATION_CANCELLED)
            }
            None => crate::tr!(crate::keys::PRESENTATION_OPERATION_SERVICE_MIGRATION),
        };
        frame.render_widget(
