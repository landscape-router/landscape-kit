...
pub(crate) struct UpdateScreen;

impl OperationScreen for UpdateScreen {
    fn result_key(&self, result: OperationResult) -> &'static str {
        match result {
            OperationResult::Success => crate::keys::PRESENTATION_UPDATE_COMPLETE,
            OperationResult::Failed => crate::keys::PRESENTATION_UPDATE_FAILED,
            OperationResult::Cancelled => crate::keys::PRESENTATION_UPDATE_CANCELLED,
        }
    }
    ...
    fn render(
        ...
        let header_text = match result {
            Some(OperationResult::Success) => {
                crate::tr!(crate::keys::PRESENTATION_UPDATE_COMPLETE)
            }
            Some(OperationResult::Failed) => {
                crate::tr!(crate::keys::PRESENTATION_UPDATE_FAILED)
            }
            Some(OperationResult::Cancelled) => {
                crate::tr!(crate::keys::PRESENTATION_UPDATE_CANCELLED)
            }
            None => crate::tr!(crate::keys::PRESENTATION_OPERATION_UPDATE),
        };
        frame.render_widget(
