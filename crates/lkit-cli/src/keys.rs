...
pub(crate) const CONSOLE_VERSIONS: &str = "console.versions";
pub(crate) const CONSOLE_CONFIGURATION: &str = "console.configuration";
pub(crate) const CONSOLE_SERVICES: &str = "console.services";
pub(crate) const CONSOLE_NETWORK: &str = "console.network";
pub(crate) const CONSOLE_DIAGNOSTICS: &str = "console.diagnostics";
...
pub(crate) const CONSOLE_NOT_AVAILABLE_IN_THIS_RELEASE: &str =
    "console.not_available_in_this_release";
