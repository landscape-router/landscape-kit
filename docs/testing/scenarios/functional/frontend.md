...
- 测试层：单元 + e2e fixture
- 状态：`已覆盖`
- 证据：`install_applies_the_configured_custom_frontend`、
  `install_blocks_on_an_unreachable_frontend_source`（lkit-cli/tests/install_fixture_e2e/frontend.rs）
