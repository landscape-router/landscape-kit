...
- 测试层：CLI fixture E2E
- 状态：`已覆盖`
- 证据：[网络重配置](../../../network/reinit.md)、[网络发现](../../../../lkit-cli/src/network/discovery.rs)、[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e/reinit.rs)
...
- 测试层：CLI fixture E2E
- 状态：`已覆盖`
- 证据：[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e.rs)、[`.lkb` 备份与回滚](../../../backup/lkb-and-rollback.md)
...
- 测试层：CLI fixture E2E
- 状态：`已覆盖`
- 证据：[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e.rs)、[reinit 工作流](../../../../lkit-cli/src/workflows/reinit.rs)
...
- 状态：`部分覆盖`
- 证据：[网络重配置](../../../network/reinit.md)、[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e.rs)
...
- 状态：`已覆盖`
- 证据：[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e.rs)、[控制台测试](../../../../lkit-cli/src/console/tests/reinit.rs)
...
- 测试层：CLI fixture E2E
- 状态：`已覆盖`
- 证据：[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e.rs)、[事务与中断恢复](../../../deployment/transactions-and-recovery.md)
...
- 测试层：CLI fixture E2E
- 状态：`已覆盖`
- 证据：[reinit 工作流](../../../../lkit-cli/src/workflows/reinit.rs)、[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e/reinit.rs)
...
- 状态：`已覆盖`
- 证据：[事务与中断恢复](../../../deployment/transactions-and-recovery.md)、[事务测试](../../../../lkit-cli/src/deployment/transaction/mod.rs)
...
- 状态：`已覆盖`
- 证据：[控制台测试](../../../../lkit-cli/src/console/tests/reinit.rs)
