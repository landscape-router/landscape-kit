...
- 证据：[`lkit uninstall`](../../../commands/uninstall.md)、[生命周期 9. 卸载](../../../workflows/lifecycle.md#9-卸载)、
  `systemd_mode_unregisters_the_unit_but_not_lkit_daemon`（lkit-cli/src/workflows/uninstall/cleanup.rs）、
  `uninstalls_an_existing_installation_through_full_cli`（lkit-cli/tests/install_fixture_e2e/uninstall.rs）
...
- 证据：[`lkit uninstall`](../../../commands/uninstall.md)、[输出与退出码](../../../commands/output-and-exit-codes.md)、
  `requires_yes_in_non_interactive_mode`（lkit-cli/src/workflows/uninstall/mod.rs）
...
- 证据：[`lkit uninstall`](../../../commands/uninstall.md#卸载前检查)、
  `blocks_without_allow_no_backup_when_protection_fails`（lkit-cli/src/workflows/uninstall/mod.rs）
...
- 证据：[事务与中断恢复](../../../deployment/transactions-and-recovery.md)、
  `continues_with_allow_no_backup_when_protection_fails`（lkit-cli/src/workflows/uninstall/mod.rs）
...
- 证据：[卸载语义](../../../deployment/layout-and-state.md#卸载语义)、
  `uninstalls_none_mode_and_keeps_the_lkit_territory`（lkit-cli/src/workflows/uninstall/cleanup.rs）、
  `uninstalls_an_existing_installation_through_full_cli`（lkit-cli/tests/install_fixture_e2e/uninstall.rs）
...
- 证据：[`lkit uninstall`](../../../commands/uninstall.md#清理选项)、
  `keep_data_preserves_data_and_removes_the_rest`（lkit-cli/src/workflows/uninstall/cleanup.rs）
...
- 证据：[中断恢复](../../../deployment/transactions-and-recovery.md)、
  `recovers_interrupted_uninstall_by_forward_completion`（lkit-cli/src/deployment/transaction/recovery.rs）
...
- 状态：`已覆盖`
- 证据：[`lkit uninstall`](../../../commands/uninstall.md)、[完整 CLI E2E](../../../../lkit-cli/tests/install_fixture_e2e/uninstall.rs)
