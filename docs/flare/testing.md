...
| `FLR-19` 至 `FLR-26` | daemon 托管与连接生命周期；完整故障场景仍有缺口 | `scripts/flare/e2e-daemon.sh` + `scripts/flare/e2e-connections.sh` + `install_fixture_e2e/self_cmd.rs` + [scenarios.md](scenarios.md) |
